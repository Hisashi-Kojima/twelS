# Generated by Django 4.1.3 on 2022-12-31 05:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_request_date', models.DateTimeField(blank=True, default=datetime.datetime(2022, 12, 31, 5, 51, 30, 400080), null=True, verbose_name='first request date')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('email_request_times', models.PositiveSmallIntegerField(default=0, help_text='Designates how many times this user sent email-request for certification', verbose_name='email request times')),
                ('first_request_date', models.DateTimeField(blank=True, default=datetime.datetime(2022, 12, 31, 5, 51, 30, 397824), null=True, verbose_name='first request date')),
